...
const (
	...
	Dm_build_345 uint16 = uint16(Dm_build_341)

	Dm_build_346 uint16 = uint16(Dm_build_342)
	...
	Dm_build_355 byte = Dm_build_350
	...
	Dm_build_382 int16 = Dm_build_381 + 20

	Dm_build_383 int16 = Dm_build_381 + 21

	Dm_build_384 int16 = Dm_build_381 + 22

	Dm_build_385 int16 = Dm_build_381 + 24

	Dm_build_386 int16 = Dm_build_381 + 25

	Dm_build_387 int16 = Dm_build_381 + 26

	Dm_build_388 int16 = Dm_build_381 + 30

	Dm_build_389 int16 = Dm_build_381 + 31

	Dm_build_390 int16 = Dm_build_381 + 32

	Dm_build_391 int16 = Dm_build_381 + 33

	Dm_build_392 int16 = Dm_build_381 + 35

	Dm_build_393 int16 = Dm_build_381 + 38

	Dm_build_394 int16 = Dm_build_381 + 39

	Dm_build_395 int16 = Dm_build_381 + 51

	Dm_build_396 int16 = Dm_build_381 + 71

	Dm_build_397 int16 = Dm_build_381 + 124

	Dm_build_398 int16 = Dm_build_381 + 125

	Dm_build_399 int16 = Dm_build_381 + 126

	Dm_build_400 int16 = Dm_build_381 + 127

	Dm_build_401 int16 = Dm_build_381 + 128

	Dm_build_402 int16 = Dm_build_381 + 129
	...
	for _, param := range dm_build_525.dm_build_518 {
		if param.bytes == nil {
			...
			if len(dataBytes) > int(Dm_build_338) {
				if dm_build_525.dm_build_433.dm_build_6.MsgVersion >= Dm_build_292 && len(dataBytes) < 0xffffffff &&
		...
		if dm_build_570[i] == nil {
			...
			case []byte:
				if dataBytes, ok := dm_build_570[i].([]byte); ok {
					if len(dataBytes) > int(Dm_build_338) {
						if dm_build_569.dm_build_433.dm_build_6.MsgVersion >= Dm_build_292 && len(dataBytes) < 0xffffffff &&
...
func (dm_build_574 *dm_build_540) dm_build_422() (interface{}, error) {
	...
	case Dm_build_388, Dm_build_390, Dm_build_389:
		...
		dm_build_574.dm_build_615(&dm_build_575)

		if dm_build_574.dm_build_435 == EC_BP_WITH_ERROR.ErrCode {
			dm_build_574.dm_build_609(dm_build_575.updateCounts)
		}
	case Dm_build_397:
		len := dm_build_574.dm_build_433.dm_build_5.Dm_build_1431()
		dm_build_576.FormatDate = dm_build_574.dm_build_433.dm_build_5.Dm_build_1456(int(len), dm_build_576.getServerEncoding(), dm_build_576)
	case Dm_build_399:

		len := dm_build_574.dm_build_433.dm_build_5.Dm_build_1431()
		dm_build_576.FormatTimestamp = dm_build_574.dm_build_433.dm_build_5.Dm_build_1456(int(len), dm_build_576.getServerEncoding(), dm_build_576)
	case Dm_build_400:

		len := dm_build_574.dm_build_433.dm_build_5.Dm_build_1431()
		dm_build_576.FormatTimestampTZ = dm_build_574.dm_build_433.dm_build_5.Dm_build_1456(int(len), dm_build_576.getServerEncoding(), dm_build_576)
	case Dm_build_398:
		len := dm_build_574.dm_build_433.dm_build_5.Dm_build_1431()
		dm_build_576.FormatTime = dm_build_574.dm_build_433.dm_build_5.Dm_build_1456(int(len), dm_build_576.getServerEncoding(), dm_build_576)
	case Dm_build_401:
		len := dm_build_574.dm_build_433.dm_build_5.Dm_build_1431()
		dm_build_576.FormatTimeTZ = dm_build_574.dm_build_433.dm_build_5.Dm_build_1456(int(len), dm_build_576.getServerEncoding(), dm_build_576)
	case Dm_build_402:
...
func (dm_build_585 *dm_build_540) dm_build_584(dm_build_586 int) [][]byte {
	...
	for i := 0; i < dm_build_586; i++ {
		...
		if dm_build_590 == int32(Dm_build_341) {
			dm_build_590 = 0
			dm_build_591 = true
		} else if dm_build_590 == int32(Dm_build_342) {
...
func (dm_build_594 *dm_build_540) dm_build_593(dm_build_595 int, dm_build_596 bool) []column {
	...
	for i := 0; i < dm_build_595; i++ {
		...
		if isComplexType(int(dm_build_602[i].colType), int(dm_build_602[i].scale)) {
			...
			strDesc.unpack(dm_build_594.dm_build_433.dm_build_5)
...
func (dm_build_795 *dm_build_776) dm_build_794(dm_build_796 int) []parameter {
	...
	for i := 0; i < dm_build_796; i++ {
		...
		if isComplexType(int(dm_build_801[i].colType), int(dm_build_801[i].scale)) {
			...
			strDesc.unpack(dm_build_795.dm_build_433.dm_build_5)
...
func (dm_build_925 *dm_build_918) dm_build_418() error {
	...
	for _, tableID := range dm_build_925.dm_build_919 {
		dm_build_925.dm_build_433.dm_build_5.Dm_build_1357(uint32(tableID))
	}
